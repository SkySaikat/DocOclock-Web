        ...
        <GlassCard className="p-6 bg-white border-0 ring-1 ring-slate-100 shadow-xl rounded-[2.5rem]">
          <div className="flex items-center gap-5">
            ...
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-tr from-blue-600 to-teal-400 rounded-2xl flex items-center justify-center text-white text-3xl font-black shadow-2xl ring-4 ring-white">
              ...
              <div className="divide-y divide-slate-50">
                {section.items.map((item, i) => (
                  <div
                    ...
                    className="p-4 flex items-center gap-4 hover:bg-blue-50/30 transition-all cursor-pointer group"
                  >
