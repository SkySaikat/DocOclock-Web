...
const App: React.FC = () => {
  ...
  const [activeRxPatient, setActiveRxPatient] = useState<{ name: string; age?: number; gender: string; phone: string } | null>(null);

  // SHARED DATABASE: Holds all prescriptions created during the session
  ...
  const renderView = () => {
    ...
    switch (currentPath) {
      case '/':
      case '/patient/home': 
        return <Home onNavigate={navigate} onSelectDoctor={handleSelectDoctor} userRole={userRole} focusSearchTrigger={focusSearchTrigger} allPrescriptions={allPrescriptions} />;
      ...
      case '/patient/prescriptions': return isPatient ? <Prescriptions onNavigate={navigate} customPrescriptions={allPrescriptions} /> : <Home onNavigate={navigate} onSelectDoctor={handleSelectDoctor} userRole={userRole} />;
      ...
      case '/patient/medicine-tracker': return isPatient ? <MedicineTracker allPrescriptions={allPrescriptions} /> : <Home onNavigate={navigate} onSelectDoctor={handleSelectDoctor} userRole={userRole} />;
      case '/live-serial': return isPatient ? <LiveSerial /> : <Home onNavigate={navigate} onSelectDoctor={handleSelectDoctor} userRole={userRole} />;
